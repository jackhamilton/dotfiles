return {
    ...
    keys = {
        ...
        -- toggle
        { "<leader>ta", function() Snacks.toggle.animate():toggle() end, desc = "Toggle animation" },
        { "<leader>td", function() Snacks.toggle.diagnostics():toggle() end, desc = "Toggle diagnostics" },
        { "<leader>tD", function() Snacks.toggle.dim():toggle() end, desc = "Toggle dimming" },
        { "<leader>ti", function() Snacks.toggle.indent():toggle() end, desc = "Toggle indent guides" },
        { "<leader>tI", function() Snacks.toggle.inlay_hints():toggle() end, desc = "Toggle inlay hints" },
        { "<leader>tl", function() Snacks.toggle.line_number():toggle() end, desc = "Toggle line numbers" },
        { "<leader>tp", function() Snacks.toggle.profiler():toggle() end, desc = "Toggle profiler" },
        { "<leader>tH", function() Snacks.toggle.profiler_highlights():toggle() end, desc = "Toggle profiler highlights" },
        { "<leader>ts", function() Snacks.toggle.scroll():toggle() end, desc = "Toggle smooth scroll" },
        { "<leader>tt", function() Snacks.toggle.treesitter():toggle() end, desc = "Toggle Treesitter" },
        { "<leader>tw", function() Snacks.toggle.words():toggle() end, desc = "Toggle LSP words" },
